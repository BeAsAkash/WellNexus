...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages=
            {
                    ...
                    {"HealthVit Chromium Picolinate 200mcg Capsuel","","","","305"},
    ...
    private String[] package_details={
            "Building and keeping the bones and teeth strong\n"+
                    ...
                    "Boosting immunity",
            "Plays an important role in helping insulin regulate blood glucose",
            "Helps in formation of red blood cells.\n"+
                    "Maintais healthy nervous system.\n",
            "It helps reduce skin blemish and pigmentation.\n"+
                    "It acts as safeguard the skin from the harsh UVA and UVB sun rays.",
            "Helps relieve pain and fever.",
            "Helps relieve bring down high body  temperature.\n"+
